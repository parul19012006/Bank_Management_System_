...
public class SignUpThree extends JFrame{
	...
	public SignUpThree() {
		...
		JLabel number = new JLabel("XXXX-XXXX-XXXX-4563");
		card.setFont(new Font("Raleway" , Font.BOLD , 22));
		card.setBounds(330,300,300,30);
		add(card);
		
		JLabel card1 = new JLabel("Your 16 digit card number");
		card1.setFont(new Font("Raleway" , Font.BOLD , 12));
		card1.setBounds(100,300,200,20);
		add(card1);
		...
		c2.setBounds(150,500,200,30);
		add(c2);
		
		c3 = new JCheckBox("Mobile Banking");
		c3.setBackground(Color.WHITE);
		c3.setFont(new Font("Raleway" , Font.BOLD , 16));
		c3.setBounds(200,500,200,30);
		add(c3);
		
		c4 = new JCheckBox("Email and SMS Alerts");
		c4.setBackground(Color.WHITE);
		c4.setFont(new Font("Raleway" , Font.BOLD , 16));
		c4.setBounds(250,500,200,30);
		add(c4);
		
		c5 = new JCheckBox("Cheque Books");
		c5.setBackground(Color.WHITE);
		c5.setFont(new Font("Raleway" , Font.BOLD , 16));
		c5.setBounds(300,500,200,30);
		add(c5);
		
		c6 = new JCheckBox("Declares that the above information is correct according to the best of my knowledge");
